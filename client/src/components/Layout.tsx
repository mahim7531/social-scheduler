...
const pageTiles:Record<string,string> = {
    "/dashboard": "Dashboard",
...
const Layout = () => {
 ...
 const title=pageTiles[location.pathname] || "SocialAI";
  ...
  return (
    ...
    <div className='flex h-screen bg-slate-50'>
        {/* Mobile Overlay */}
        {isMobileMenuOpen && <div className="flex inset-0 bg-slate-900/50 z-40 md:hidden" onClick={() => setIsMobileMenuOpen(false)}/>}
